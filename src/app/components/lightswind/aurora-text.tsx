  ...
  return (
    <div
      className={cn(
        ...
        "aurora dark:bg-black flex items-center justify-center overflow-hidden",
        className
      )}
    >
      ...
      <div className="text-center">
        <h1
          className={cn(
            ...
            "py-3 px-3 roboto-slab text-3xl sm:text-5xl font-extrabold tracking-tight relative overflow-hidden text-black dark:text-white",
            textClassName
          )}
          style={{ fontSize }}
        >
