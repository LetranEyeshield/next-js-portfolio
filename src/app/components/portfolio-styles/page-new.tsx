...
export default function PageNew() {
  const projects = [
    ...
    },
    {
      ...
      description:
        "A healthcare-focused appointment scheduling platform enabling patients to book, manage, and track check-ups online. Built with Next.js and MongoDB, featuring API-driven communication via Axios and a responsive UI optimized for accessibility and real-world clinic workflows.",
  ...
  const seeMoreProjects = [
    ...
    },
    {
      ...
      description:
        "A modern event website designed for wedding announcements and guest coordination. Features RSVP handling, responsive design, and automated email confirmations to enhance guest engagement and event organization.",
      tech: ["Next.js", "Javascript", "Typescript", "Nodemailer"],
    },
    {
  ...
  const displayedProjects = show ? [...projects, ...seeMoreProjects] : projects;
    ...
    <main className="bg-black text-white">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-6">
        ...
        <p className="text-gray-400 max-w-2xl mb-8">
          Full Stack Developer building scalable web applications using Next.js,
          Javascript, TypeScript, MongoDB, and modern backend systems.
        </p>
      ...
      <section id="projects" className="py-24 px-6 bg-neutral-950">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold aurora-text">My Projects</h2>
      ...
      >
        ...
        <p className="text-gray-400 mb-8">
          Open to junior developer roles, startup teams, and collaborative
          projects.
        </p>
